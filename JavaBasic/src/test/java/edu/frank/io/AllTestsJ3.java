 ...
 * File Name : AllTestsJ3.java
 * File Version : 1.0.0.0
 *
 *
 * Author : yoyu
 * Date : 2011-3-2 06:03:11
 * History :
 * <Name>				<Date>				<Content>
 *
 */
...
public class AllTestsJ3 {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("Test for com.yoyudeng.io");
		//$JUnit-BEGIN$
		suite.addTestSuite(UseSerializableTest.class);
		suite.addTestSuite(ForTestingTest.class);
		suite.addTestSuite(InternalFileReaderTest.class);
		//suite.addTest(new JUnit4TestAdapter(AllTestJ4.class));
		//$JUnit-END$
		return suite;
	}
