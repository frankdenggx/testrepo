 ...
 */
public class NeOrderGuideTemplate extends Template {
	 ...
	 * @since HOZDoEAS7.0 1.0
	 */
	private static Logger logger = Log4JConfig.getLogger(NeOrderGuideTemplate.class);
	 ...
	 * @since HOZDoEAS7.0 1.0
	 */
	public NeOrderGuideTemplate(){
		super();
		this.templateId = getClass().toString();
		this.templateName = getClass().getName();
		this.templateDescription = "";
		this.templateManager = NeOrderGuideTemplateManager.getManager();
	}
